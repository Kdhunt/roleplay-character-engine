...
ARCHITECTURE.md owns boundaries and defaults. DOMAIN.md owns entities/invariants/lifetimes. API.md owns routes/DTO/error/event behavior; RCE-053 turns it into executable OpenAPI and runtime schemas. CLIENT.md owns screens and interaction states. QUALITY.md owns verification and release evidence. STORY_TEMPLATE.md defines bounded coding tasks. SOURCES.md records primary external references.
